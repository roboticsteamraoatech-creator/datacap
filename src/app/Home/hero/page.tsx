        ...
        >
          ...
          >
            <>
              ...
              >
                {/* Capture Image Button - RESTORED original styling */}
                <label className="cursor-pointer inline-block">
                  <div
                    role="button"
                    aria-label="Upload Image"
                    ...
                    style={{
                      ...
                      fontFamily: "Manrope",
                      fontWeight: 600,
                      fontSize: "14px", // Original size from your code
                      lineHeight: "100%",
                    }}
                    onMouseEnter={(e) => {
                      const el = e.currentTarget as HTMLDivElement
                  ...
                  >
                    ...
                    <svg
                      className="w-4 h-4 inline-block" // This is 16px (4 * 4px = 16px)
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      aria-hidden="true"
        ...
        >
          ...
          >
            <>
              ...
              {/* Upload Button - RESTORED original mobile styling */}
              <div 
                className="absolute"
                style={{
                  bottom: "15px",
                ...
                <label className="cursor-pointer inline-block">
                  <div
                    ...
                    style={{
                      ...
                      fontFamily: "Manrope",
                      fontWeight: 600,
                      fontSize: "12px", // Original mobile size from your code
                      lineHeight: "100%",
                      gap: "6px",
                    }}
                  >
